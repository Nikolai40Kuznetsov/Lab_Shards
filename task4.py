...
to disk = 'D:\User_ActionsMIWN36_backup.bak' 
with format, 
...
exec [master].[dbo].[sp_RestoreDatabaseFromBackup]
    @BackupFilePath = 'D:\User_ActionsMIWN36_backup.bak',
    @NewDBName = 'User_ActionsMIWN36_backupDB',
